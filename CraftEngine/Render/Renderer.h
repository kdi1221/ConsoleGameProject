...
namespace Craft
{
	...
	public:
		...
		void Submit(const std::wstring& image, const Vector2Int& position, Color color = Color::White, int sortingOrder = 0);

		//UI 구성하는 데이터를 전달하는 함수.
		void SubmitUI(const std::wstring& image, const Vector2Int& position, Color color = Color::White, int sortingOrder = 0);
